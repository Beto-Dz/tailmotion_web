/**
 * animation: Define animaciones. Cada clave representa una animación, y el valor indica los keyframes y propiedades adicionales (duración, timing, repetición).
 * keyframes: Define los pasos clave para las animaciones.
 * animationDelay: Define el retraso para comenzar las animaciones
 * animationDuration: Define la duración de las animacionez
 */
export default {
    animation: {
